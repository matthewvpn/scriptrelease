...
apt update
HOST='185.61.137.171';
USER='matthewv2_voltagepanel';
PASS='F10090@2024';
DBNAME='matthewv2_voltagepanel';
...
#====================================================
#	Installing OpenVPN
#	Finalized: VOLTAGE-PROTECT DEVELOPER
#====================================================
...
echo '#Openvpn Configuration by voltage-Protect Developer :)
dev tun
port PORT_UDP
proto udp
...
echo "Made with love by: VOLTAGE-PROTECT DEVELOPER... " >> /root/.web/index.php
...
clear
echo '++++++++++++++++++++++++++++++++++'
echo '*       VOLTAGE-PROTECT AIO SCRIPT  IS READY!    *'
echo '+++++++++++************+++++++++++'
history -c;
